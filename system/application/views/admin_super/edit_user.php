...
<table><tr><td width="100">Nama User</td><td>:</td><td><input type="text" name="nama" size="40" class="input" value="<?php echo $nama; ?>" /></td></tr>
...
<tr><td>Password</td><td>:</td><td><input type="text" name="password" size="40" class="input" /> *Kosongkan jika tidak dirubah</td></tr>
