...
<a href="<?php echo base_url(); ?>index.php/superadmin/tambahuser"><div class="input">Tambah Data User</div></a><br />
<table width="100%" class="tabel" cellpadding="5" cellspacing="1"><tr bgcolor="#A1C442"><td>No.</td><td>Nama User</td><td>Username</td><td>Wilayah</td><td colspan="2" align="center">Aksi</td></tr>
<?php
$i=1;
