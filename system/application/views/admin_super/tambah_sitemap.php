...
<table>
<tr><td width="150">Sitemap Induk</td><td>:</td><td><select name="wilayah" class="input" onChange="javascript:ubahKode();"><option selected="selected">- Pilih -</option>
<?php
...
<tr><td>Kode Sitemap</td><td>:</td><td><input type="text" name="kode" class="input" size="5" /> - <input type="text" name="angka1" class="input" size="5" /> - <input type="text" name="angka2" class="input" size="5" /></td></tr>
<tr><td>Nama Wilayah</td><td>:</td><td><input type="text" name="namawil" class="input" size="40" /></td></tr>
<tr><td></td><td></td><td><input name="kirim" type="submit" value="Simpan" class="input" /> <input name="hapus" type="reset" value="Hapus" class="input"/></td></tr>
</table>
</form>
</div>
</div>
