...
<title><?php echo $nm_site3; ?> - Desa/Kelurahan <?php echo $nm_site2; ?> | Blog Desa Kabupaten Banyuwangi</title>
	...
	<div id="templatemo_header">
        ...
        <div id="site_title">
            <a href="<?php echo base_url(); ?>" target="_parent">
                Blog Desa - Desa <?php echo $nm_site2; ?>
		...
		<ul>
			<li><a href="<?php echo base_url(); ?>index.php/desa/home/<?php echo $kode_wil; ?>/<?php echo $link_seo; ?>">Beranda</a><ul></ul></li>
			<?php
				$i = 1;
				foreach($menu_default->result_array() as $md)
				{
					$link_seo_md = str_replace(" ","-",$md['judul_sitemap']);
					echo "<li><a href='".base_url()."index.php/desa/mainkonten/".$md['kode_wilayah']."/".$md['kode_sitemap']."/".$link_seo_md."'><span>".$md['judul_sitemap']."</span>
					</a>";
					...
					foreach($sub_menu_default->result_array() as $smd)
						{
							...
							echo "<li><a href='".base_url()."index.php/desa/konten/".$smd['kode_wilayah']."/".$smd['kode_sitemap']."/".$link_seo_smd."'>".$smd['judul_sitemap']."
							</a>";
							echo "<ul>";
							...
							foreach($sub_sub_menu_default->result_array() as $ssmd)
							{
								...
								echo "<li><a href='".base_url()."index.php/desa/subkonten/".$ssmd['kode_wilayah']."/".$ssmd['kode_sitemap']."/".$link_seo_smd."'>".$ssmd[
								'judul_sitemap']."</a></li>";
							}
							echo "</ul></li>";
						}
...
<div id="templatemo_feature_wrapper">
	<div id="templatemo_feature">
        ...
        <img src="<?php echo base_url(); ?>asset/main_web/images/banner2.png" />
