...
<div id="templatemo_sidebar_luar"> 
    <div id="templatemo_sidebar">
        <h2><span>Potensi Daerah <?php echo $nm_site2; ?></span></h2>
        <div class="newsbox">
	...
	<div id="templatemo_sidebar">
        ...
        <div class="newsbox">
		<ul class="li-class">
        	<li class="li-class"> Dikunjungi oleh : 10167 user</li>
			<li class="li-class"> IP address : 222.124.156.242</li>
			<li class="li-class"> OS : Unknown Windows OS</li>
			<li class="li-class"> Browser : Firefox 3.6.17</li>
		</ul>
        </div>
	</div>
