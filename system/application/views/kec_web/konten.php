	<div id="templatemo_content">
		...
		<?php
			foreach($kumpulan_konten->result_array() as $kk)
			{
				...
				echo "<a href='".base_url()."index.php/kec/isi/".$id_site2."/".$kk['kode_sitemap']."/".$kk['kode_konten']."'><h6>".$kk['judul_konten']."</h6></a>";
				...
				echo "<div id='bar_artikel'><a href='".base_url()."index.php/kec/isi/".$id_site2."/".$kk['kode_sitemap']."/".$kk['kode_konten']."'><span class='baca'>
				Baca Selengkapnya</span></a> <a href='".base_url()."index.php/kec/isi/".$id_site2."/".$kk['kode_sitemap']."/".$kk['kode_konten'].
