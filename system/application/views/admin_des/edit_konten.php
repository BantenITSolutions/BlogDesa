...
?>
<?php echo form_open_multipart('admindes/updatekonten');?>
<table height="100%">
<tr>
...
<textarea name="isi"><?php echo $isi_konten; ?></textarea></td>
</tr>
<tr>
<td valign="top"> </td><td>
<input type="submit" value="Simpan" class="input" /> <input type="reset" value="Hapus" class="input" /><input type="hidden" name="kd_konten" value="<?php echo $kd_konten; ?>" /></td>
</tr>
</table>
            </form>
        </div>
        ...
        <div class="Page">
        <!--Page 2 --> 
	<form name="formupload" enctype="multipart/form-data" action="<?php echo base_url()?>index.php/admindes/uploadfile" method="POST"><input type="hidden" name="kd_wil" value="<?php echo $kode_wil; ?>" />
	...
	{
		echo "<tr><td>".$im['judul_file']."</td><td><a href='".base_url()."index.php/admindes/hapusmedia/".$im['kode_media']."'>Hapus</a></td></tr>";
	}
	?>
	</table>
        </div>
