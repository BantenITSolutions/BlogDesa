...
foreach($konten->result_array() as $k)
{
	...
	<div><a href='".base_url()."index.php/admindes/editkonten/".$k['kode_konten']."'>Edit Konten</a></div></div></div>";
	foreach($komentar->result_array() as $km)
	{
		...
		."index.php/admindes/editkomentar/".$km['kode_komentar']."'>Edit Komentar</a> | <a href='".base_url()."index.php/admindes/hapuskomentar/".$km['kode_komentar']."'";
		?>
