...
<form method="post" action="<?php echo base_url(); ?>index.php/admindes/updatemenu" name="soal">
...
foreach($menu_default->result_array() as $md)
{
	...
	$sm = $this->Admindesa_model->Semua_Menu_Anak($md['kode_sitemap']);
	...
	$sm2 = $this->Admindesa_model->Semua_Menu_Anak($sma->kode_sitemap);
