...
<a href="<?php echo base_url(); ?>index.php/admindes/tambahkonten"><div class="input">Tambah Konten</div></a><br />
...
foreach($konten->result_array() as $k)
{
	...
	echo "<td align='center'><a href='".base_url()."index.php/admindes/editkonten/".$k['kode_konten']."'><div class='input'>Edit</div></a></td>";
	echo "<td align='center'><a href='".base_url()."index.php/admindes/hapuskonten/".$k['kode_konten']."'"; 
