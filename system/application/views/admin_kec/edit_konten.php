...
?>
<?php echo form_open_multipart('adminkec/updatekonten');?>
<table height="100%">
<tr>
...
<input type="submit" value="Simpan" class="input" /> <input type="reset" value="Hapus" class="input" /><input type="hidden" name="kd_konten" value="<?php echo $kd_konten; ?>" /></td>
	...
	{
		echo "<tr><td>".$im['judul_file']."</td><td><a href='".base_url()."index.php/adminkec/hapusmedia/".$im['kode_media']."'>Hapus</a></td></tr>";
	}
	?>
	</table>
        </div>
