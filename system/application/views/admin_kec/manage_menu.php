...
<form method="post" action="<?php echo base_url(); ?>index.php/adminkec/updatemenu" name="soal">
...
foreach($menu_default->result_array() as $md)
{
	...
	$sm = $this->Adminkecamatan_model->Semua_Menu_Anak($md['kode_sitemap']);
	...
	$sm2 = $this->Adminkecamatan_model->Semua_Menu_Anak($sma->kode_sitemap);
