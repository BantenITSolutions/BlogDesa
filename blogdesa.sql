...
--
-- Host: localhost
-- Generation Time: May 24, 2011 at 10:34 PM
...
CREATE TABLE IF NOT EXISTS `tbl_komentar` (
  `kode_komentar` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_konten` (
  `kode_konten` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_media` (
  `kode_media` int(10) NOT NULL AUTO_INCREMENT,
  `kode_wilayah` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_menu_per_daerah` (
  `kode_wilayah` varchar(10) NOT NULL,
  `kode_sitemap` varchar(10) NOT NULL,
  `status` varchar(1) NOT NULL
...
CREATE TABLE IF NOT EXISTS `tbl_setting` (
  `kode_setting` int(10) NOT NULL AUTO_INCREMENT,
  `isi_setting` text NOT NULL,
  `tipe_setting` varchar(50) NOT NULL,
  PRIMARY KEY (`kode_setting`)
